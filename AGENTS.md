...
This independent leaf repository owns its manifest, shape-domain implementation,
...
`surgeist-shape` owns resolved shape and geometry, primitive path data, and their
invariants. It excludes style resolution, layout, GPU and render resources,
widgets, and application behavior. Surgeist-to-Surgeist lowering and adapters
